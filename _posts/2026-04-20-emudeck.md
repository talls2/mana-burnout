...
date: 2026-04-20
author: williambenett
tags: [games, emulation, software]
image: /images/2026-04-20-emudeck/cover.jpg
---
...
For PS2, PCSX2 accepts `.iso`, `.bin/.cue`, and compressed `.chd` files. CHD is worth knowing about — it's a lossless compressed format that can cut a 4GB ISO down to 1–2GB while still working perfectly in PCSX2.
...
Without the BIOS/firmware, the emulators will open but refuse to launch games. This is one of the steps people get stuck on, so get it done before moving forward.
...
This is the payoff. Open Steam in Big Picture mode (the TV/couch interface), connect your controller, and navigate to your library. PS2 games, GameCube games, everything — it all shows up in one place and launches with a single button press.
